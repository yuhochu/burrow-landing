...
export const NEAR_STORAGE_DEPOSIT = Number(process.env.VITE_PUBLIC_NEAR_STORAGE_DEPOSIT) || 0.25;
...
export const isBeta = process.env.VITE_PUBLIC_CONTRACT_NAME === CONTRACT_BETA;
export const isMain = process.env.VITE_PUBLIC_CONTRACT_NAME === CONTRACT_MAIN;
