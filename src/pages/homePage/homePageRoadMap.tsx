...
const _Row = (props: RowProps) => {
  return (
    <div className={'my-16 flex justify-between items-center'} style={props?.style}>
      <SignBoard style={props?.signBoardWrapStyle} signBoardStyle={props?.signBoardStyle}>
...
const SignBoard = ({ children, style, signBoardStyle }: SignBoardProps) => {
  return (
    <div className={'signboard-wrap'} style={style}>
      <div className={'signboard'} style={signBoardStyle}>{children}</div>
      <div className={'relative signboard-stand'}>
        <div
          className={'signboard-stick absolute z-1'}
